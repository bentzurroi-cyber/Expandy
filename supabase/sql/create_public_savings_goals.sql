-- Run in Supabase SQL Editor if `public.savings_goals` is missing.
-- Same as migration `20260404100000_savings_goals.sql`.
...
create table if not exists public.savings_goals (
  ...
  monthly_current numeric(14, 2) not null default 0 check (monthly_current >= 0),
