-- Deep rewrite: approve_household_join_request with explicit import/no-import flows,
-- dependency-safe cleanup order, and clear JSON error reporting.
...
begin
  ...
  -- Lock pending request row to prevent races.
  select
    r.id,
    r.requester_id,
    r.household_code,
